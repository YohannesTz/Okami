...
class MangaPagingSource @Inject constructor(private val kitsuClient: KitsuClient): PagingSource<Int, Data>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Data> {
        return try {
            ...
            kitsuClient.getMangas(currentPage)?.let { responseData.addAll(it) }
